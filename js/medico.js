document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("js/medicos.xml")
    ...
    .then((data) => {
      ...
      const medicosNombres = Array.from(medicos).map((medico) =>
        medico.querySelector("nombre").textContent.toLowerCase()
      );
      const medicosEspecialidad = Array.from(medicos).map((medico) =>
        medico.querySelector("especialidad").textContent.toLowerCase()
      );
      const medicosUbicacion = Array.from(medicos).map((medico) =>
        medico.querySelector("ubicacionConsulta").textContent.toLowerCase()
      );
      ...
      fetch("js/medicos.xml")
        ...
        .then((data) => {
          ...
          medicos.forEach((medico) => {
            ...
            const especialidad =
              medico.querySelector("especialidad").textContent;
            const ubicacion =
              medico.querySelector("ubicacionConsulta").textContent;
            const horarioConsulta =
              medico.querySelector("horariosConsulta").textContent;
